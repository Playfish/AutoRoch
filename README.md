...
And then double-click ```ros-indigo-autoroch_0.0.1-0trusty-20171103-144719-0700_amd64.deb``` for install.
...
After startup AutoRoch, please read ```/docs/user_manual/AutoRoch用户手册V0.0.1_测试版.pdf``` for using.
